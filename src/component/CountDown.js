...
//     <div className="btn-timer d-flex">
//       <span>
//         {days === "NaN" || days <= 0
//           ? ""
//           : days === 1
...
//   ) : (
//     <div className="row">
//       <div className="col-3 border-end brd-yellow mx-2 px-2">
...
export default function CountDown({ props }) {
  ...
  return props?.type === "ticket" ? (
    <div className="d-flex justify-content-center fw-bold border border-2 ps-0 p-1">
      <span>
        {days === "NaN" || days <= 0
          ? ""
          : days === 1
    ...
    <div className="row border-bottom">
      <div className="col-3 border-end brd-yellow ">
        <h1 className="fw-bold m-0" style={{ width: "60px" }}>
          {days === "NaN" || days <= 0 ? "00" : isNaN(days) ? "00" : days}
        </h1>
        <p className="p-0 m-0" style={{ fontSize: "13px" }}>
          {days === 1 || days === 0 ? "Day" : "Days"}
        </p>
      </div>
      <div className="col-3 border-end brd-yellow ">
        <h1 className="fw-bold m-0" style={{ width: "60px" }}>
