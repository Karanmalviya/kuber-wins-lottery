import EmailUnvarifiedPage from './emailunvarified.component';
...
export const EmailUnvarifiedPageContainer = connect(mapStateToProps, mapDispatchToProps)(EmailUnvarifiedPage); 
