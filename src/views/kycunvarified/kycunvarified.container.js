import KycUnvarifiedPage from './kycunvarified.component';
...
export const KycUnvarifiedPageContainer = connect(mapStateToProps, mapDispatchToProps)(KycUnvarifiedPage); 
