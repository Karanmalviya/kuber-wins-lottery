...
const emptyData = {
  ...
  odds_of_win: "",
  odds_of_loss: "",
  frequency: '[{"frequency":null,"schedule":null}]',
  unmatchedMessage: "",
  status: 1,
  game_Features: "",
  game_slogan: "",
                      ...
                      <Card.Body className="card-body pt-2">
                        ...
                        <Form
                          onSubmit={async (e) => {
                            e.preventDefault();
                            if (
                              (selected.card_type === "multi-scratch"
                                ? selected.startTime !== ""
                                : true) &&
                              (selected.card_type === "multi-scratch"
                                ? selected.frequency !== ""
                        ...
                        >
                          ...
                          <Row className="row">
                            ...
                            >
                              ...
                              >
                                ...
                                <option value="single-scratch">
                                  Single Scratch
                                </option>
                                <option value="multi-scratch">
                                  Multi Scratch
                                </option>
                              </Form.Select>
                            </Col>
                          ...
                          <Row className="row">
                            ...
                            <Col
                              lg={9}
                              md={9}
                              className="col-lg-9 col-md-9 mb-1"
                            >
                              <Form.Label
                                for="inputText"
                                className="col-form-label"
                              ...
                              <Card.Body>
                                <Row className="row">
                                  ...
                                  <div style={{ fontSize: "13px" }}>
                                    Note: The CSV file header should follow the
                                    naming convention of <b>Prize</b> and{" "}
                                    <b>Odds of prize</b>
                                  </div>
